package me.dio.statesECitiesapi.City.service;

import me.dio.statesECitiesapi.City.entities.City;
import me.dio.statesECitiesapi.City.repositories.CityRepository;
import me.dio.statesECitiesapi.utils.StringLocationUtils;
...
public class DistanceService {
    ...
    public Double distanceUsingMath(final Long city1, final Long city2, final EarthRadius unit) {
        ...
        final Double[] location1 = StringLocationUtils.transform((String) cities.get(0).getGeolocation());
        final Double[] location2 = StringLocationUtils.transform((String) cities.get(1).getGeolocation());
